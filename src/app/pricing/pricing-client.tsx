...
const PLANS = [
  {
    ...
    badge: null,
    features: [
      { text: "Upwork proposals only", tag: "15 credits/mo", included: true },
      { text: "Problem Mirror style only", included: true },
      { text: "Copy to clipboard", included: true },
      { text: "Mobile friendly", included: true },
      { text: "No ads", included: true },
    ],
    notIncluded: [
      "LinkedIn InMail tool",
      "LinkedIn connection notes",
      "Cold email generator",
      "Proof Closer + Diagnostic styles",
      "Conversion tracker",
      "Analytics dashboard",
    ],
